public class Podcast {
    ...
    // Audio attributes (copied from Audio class)
    private int bitrate;
    ...
    // Constructor
    public Podcast(String title, double fileSize, double duration, int bitrate, String artist, 
    ...
    // Audio methods (copied from Audio class)
    ...
    public String toString() {
        return "Podcast[title=" + title + ", hostname=" + hostname + ", episode=" + episodeNumber + 
               ", artist=" + artist + ", fileSize=" + fileSize + ", duration=" + duration + 
               ", bitrate=" + bitrate + "]";
    }
}